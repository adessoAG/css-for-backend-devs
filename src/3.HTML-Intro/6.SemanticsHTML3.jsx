...
function SubHeading() {
  return (
    <div>
      ...
      <Text fontSize="monospace">Der Artikel <Link href="https://www.smashingmagazine.com/2019/02/buttons-interfaces/">"When Is A Button Not A Button?"</Link> zeigt sehr gut, welche Details in einem Element stecken können.</Text>
    </div>
  );
}
